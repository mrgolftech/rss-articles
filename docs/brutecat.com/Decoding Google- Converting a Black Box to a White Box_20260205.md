...
**链接:** https://brutecat.com/articles/decoding-google
**日期:** Fri, 01 Nov 2024 00:00:00 GMT
...
![Decoding Google: Converting a Black Box to a White Box](/assets/decoding-google.jpeg)
...
As it turns out, in Google, there's 4 different content types:
  ...
  * application/x-protobuf (aka. [Proto over HTTP fallback](https://googleapis.github.io/HowToRPC.html))
  * application/grpc
