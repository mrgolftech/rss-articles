...
* * *
  ...
  1. Current status update: I'm finally getting line by line structural editing done and it's turning up lots of improvements, so I'm doing more rewrites than I expected to be doing. [↩](https://buttondown.com/hillelwayne/rss#fnref:status "Jump back to footnote 1 in the text")
