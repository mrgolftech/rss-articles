...
**日期:** Tue, 09 Dec 2025 00:00:00 GMT

---

[![Pebble](/pebble-logo-red.png)](/)

[← Back to Blog](/blog)December 9, 2025

# Meet Pebble Index 01 - External Memory For Your Brain

![](/assets/meet-pebble-index-01-external-memory-for-your-brain-0-blackhero.jpg)

**Catch your best ideas before they slip through your fingers**

Do you ever have flashes of insight or an idea worth remembering? This happens to me 5-10 times every day. If I don’t write down the thought immediately, it slips out of my mind. Worst of all, I _remember_ that I’ve forgotten something and spend the next 10 minutes trying to remember what it is. So I invented external memory for my brain.
...
[Pre-order today for $75](https://repebble.com/index#buy). After worldwide shipping begins in March 2026, the price will go up to $99.

[Pre-order Now](/index#buy)
...
Now that I’ve worn my Index 01 for several months, I can safely say that it has changed my life - just like with Pebble, I couldn’t go back to a world without this. There are so many situations each day where my hands are full (while biking or driving, washing dishes, wrangling my kids, etc) and I need to remember something. A random sampling of my recent recordings:
  ...
  * _Set a timer for 3pm to go pick up the kids_
  * _Remind me to phone the pharmacy at 11am_
  * _Peter is coming by tomorrow at 11:30am, add that to my calendar_
  * _Jerry recommends reading Breakneck_
  * _Mark wants a Black/Red PT2_
...
![](/assets/meet-pebble-index-01-external-memory-for-your-brain-1-2c146dc6-62c0-4079-8f46-56413e3f5ae9.png)
...
![](/assets/meet-pebble-index-01-external-memory-for-your-brain-2-grocery-bag-silver-small.jpeg)

![](/assets/meet-pebble-index-01-external-memory-for-your-brain-3-995889e9-cbc4-4225-985a-17ec4aa5a9ee.png)
...
### #**Key Details**
  ...
  * **Works with iPhone and Android** : We overcame [Apple’s best efforts](https://ericmigi.com/blog/apple-restricts-pebble-from-being-awesome-with-iphones) to make life terrible for 3rd party accessory makers and have Index 01 working well on iOS and Android.
  * **Extremely private and secure** : Your thoughts are processed by open source speech-to-text (STT) and AI models locally on your phone. You can read the code and see exactly how it works - our [Pebble mobile app](https://github.com/coredevices/mobileapp) is open source. Higher-quality STT is available through an optional cloud service.
...
You’ll be able to pick your ring size and color after placing a pre-order. If you have a 3D printer, you can [print our CAD designs](https://github.com/coredevices/hardware/tree/main/ring/pebble-index-01/3d-cad) to try on. We’re also planning a sizing kit. You can view the [measurements of the inner diameter](https://repebble.com/index01-carousel/index01-dimensions.png) of each ring size.

![](/assets/meet-pebble-index-01-external-memory-for-your-brain-4-dd455665-61da-4315-b377-e37e90cc57b3.png)
...
Lots of stuff! Control things with the buttons. Route raw audio or transcribed text directly to your own app via webhook. Use [MCPs](https://modelcontextprotocol.io/about) (also run locally on-device! No cloud server required) to add more actions.
...
![](/assets/meet-pebble-index-01-external-memory-for-your-brain-5-cf74d4f3b974212601f09fcf5109a989.jpg)
