...
**来源:** https://jayd.ml
**链接:** https://jayd.ml/2025/05/31/adventures-in-podcasting.html
**日期:** 2025-05-31T10:29:00+00:00
...
For the first time I’ve felt betrayed somewhat by Go’s standard library. The `encoding/xml` package’s namespace support seems to be half baked, and I’ve been unable to work around some issues.
...
All good, but watch what happens when [I flip the order of `Field` and `NamespacedField` in the struct](https://go.dev/play/p/J67qm1XSWBG):
...
We’ve found an [11 year old bug](https://github.com/golang/go/issues/8535) in `encoding/xml` that Google seemingly has no desire to fix.
...
The RSS spec says the date format should be [RFC 822](http://asg.web.cmu.edu/rfc/rfc822.html#sec-5) with the example `Mon, 10 Oct 2005 14:10:00 GMT`. Apple says it should be [RFC 2822](http://www.faqs.org/rfcs/rfc2822.html) and gives the example `Sat, 01 Apr 2023 19:00:00 GMT`
...
[](/2025/05/31/adventures-in-podcasting.html)
