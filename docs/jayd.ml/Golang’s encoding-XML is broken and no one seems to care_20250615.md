...
**来源:** https://jayd.ml
**链接:** https://jayd.ml/2025/06/15/encoding-xml-is-broken-and-no-one-cares.html
**日期:** 2025-06-15T15:19:00+00:00
...
> **_Programming Note:_** _You may have subscribed to this blog because of a snarky post about YouTube that for some reason was popular. Instead of more insightful(?) content like that, you’re getting a complaint to no audience in particular about XML in Golang. You’re welcome._
...
We’ve found an [11 year old bug](https://github.com/golang/go/issues/8535) in `encoding/xml` that Google is unable or unwilling to fix. It was really not fun to discover this independently and find these ancient issues open.
...
[](/2025/06/15/encoding-xml-is-broken-and-no-one-cares.html)
