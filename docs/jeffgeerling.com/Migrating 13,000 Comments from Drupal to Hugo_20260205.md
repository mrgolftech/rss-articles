...
**日期:** Tue, 20 Jan 2026 20:43:00 -0600

---

[](https://www.jeffgeerling.com/cdn-cgi/content?id=BXAY5p2ChXJuVFDkaW6HCpB7rCe73OA7csWwnEtTLp0-1770287278.0745237-1.0.1.1-DhRJTIF7K7t8wyZhD7sSAYbSOwI3hRfMk6P5r_2oL5g)
...
![JeffGeerling.com - Remark42 comments example](/blog/2026/migrating-13000-comments-from-drupal-to-hugo/jeffgeerling-comments-remark42-v1.jpg)
...
> **Nota bene** : not one word of this blog post (nor any post on this blog, either in the past or in the future) was written by, or with the assistance of an LLMâand yes, I use em-dashes, which are easy to type on a Mac (â§ + â¥ + `-`). [Sosumi](https://alxwntr.com/classic-mac-os-sounds/)!
...
The big difference? I could supply a small set of requirements1, and **within 1-2 minutes, I would have code that runs**. Maybe not code that _works_ , but it would be in close proximity to the code that meets all my requirements.
...
AI/LLMsâeven the best 'frontier' modelsâcannot and I believe _will never_ be good at the other 80% of work involved in a content migration.

The best projectsâthe ones that don't go over budget and timelineârequire technical and project management from people who ran the gauntlet as beginners.
...
With AI/LLMs, and without the mentorship aspect, you end up with two types of developers:
  ...
  2. **Lone Wolf Developers** : Devs who _did_ go through the ringer earlier in the pre-AI era, and have the tools to play LLMs like an orchestra, building decent software _fast_ âand _alone_. And who now have no excuse to work on teams with junior devs and be the curmudgeons2 they were meant to be.
...
And they're also about the exact _opposite_ of what you'd want for QA3.
...
My requirements for a commenting system were:
  ...
  * Must allow anonymous (or at most, email-based) commentsâno 3rd party signin required.
...
I use [Amazon Simple Email Service](https://aws.amazon.com/ses/) (SES) for email notifications on the public server. It's cheaper than other options like Mailgun, and I was already familiar with it. One quirk with SES is it takes at least 12-24 hours to get fully approved, and the setup process is _slightly_ more onerous than other email providers4.
...
![JeffGeerling.com - Remark42 migration steps](/blog/2026/migrating-13000-comments-from-drupal-to-hugo/jeffgeerling-com-remark42-migration-steps-github-issue.jpg)
...
Once I got a local self-signed cert figured out, I immediately got a ton of invalid traffic on the new server. This problem ("new VPS gets flooded with traffic immediately") is a bit annoying, because VPS providers like DigitalOcean recycle IPv4 addresses quicklyâand bring along the baggage of the old IP at the same time...
...
After twiddling with some of my DDoS prevention rules in Cloudflare, I was able to get all Remark42 functionality runningâalong with all 13,000+ Drupal commentsâon this website!

## The Grass is Always Greener...

Will this site go back to a CMS at some point? Maybe. But probably not.

I spoke to a former colleague in the middle of the migrationâsomeone who's been running a personal blog on Drupal four years longer than _I_ have!
...
_However_ , part of my goal in moving to a static site is being able to test various hosting options, some of them very exoticâand limited in processing power. Therefore a static site only requiring an HTTP server and a few MB of RAM is a bonus.
...
Whatever happens, I'll continue developing my websiteâas I do all my projectsâin the open [over on GitHub](https://github.com/geerlingguy/jeffgeerling-com).

* * *

  1. Like "Here is my python export script. Add a database query that pulls all comments from a Drupal 10 database, along with comment information including email address and username, and sort that data by the node the comment is attached to, including heirarchical 'parent' information." ↩︎

  2. I don't mean this in a negative way (at least, most of the time). Much of my career (and personal) development resulted from conversations I've had with people who _vehemently_ disagreed with my take on a topic, feature, bug report, etc. Most people I initially thought were standoffish or ill-tempered were amazing to work with and helped me see something in an entirely different way. (This still happens regularly.) ↩︎

  3. Sadly, the battle for proving QA's worth is already lost in many companies. QA folks have often been the lynchpin that saves a project, in my experience, uncovering major faults well before they have a seismic impact on said project. ↩︎

  4. But it's a lot easier than maintaining my own SMTP server! Email deliverability is challenging enough when using cloud email providers... ↩︎
...
## Further reading:
  ...
  * [Local Email Debugging with Mailpit](/blog/2026/mailpit-local-email-debugging/)
  * [JeffGeerling.com has been Migrated to Hugo](/blog/2026/migrated-to-hugo/)
  * [How is Deepseek R1 on a Raspberry Pi?](/blog/2025/how-deepseek-r1-on-raspberry-pi/)



  * [remark42](/tags/remark42/)
  * [site](/tags/site/)
  * [news](/tags/news/)
  * [drupal](/tags/drupal/)
