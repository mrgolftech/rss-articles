...
**日期:** Thu, 29 Jan 2026 11:00:00 -0600

---

[](https://www.jeffgeerling.com/cdn-cgi/content?id=DsVqNlXXxX0WvqJ2xa7LgUEY_PHKIbuvYoVrKxhD9wE-1770287274.2113895-1.0.1.1-6PVEKphevXgemJRWRvSxOAFHCmXyAZgrLT59YmTbiuE)
...
![iFixit soldering hub torn down - used with permission](/blog/2026/ode-to-the-aa-battery/ifixit-soldering-usb-battery-merocle-torn-down.jpg)
...
![eneloop AA batteries](/blog/2026/ode-to-the-aa-battery/eneloop-aa-batteries.jpeg)

Each year for the past 14 years, I buy sets of [Panasonic eneloop batteries](https://amzn.to/49Gatuz) to replace disposable AA batteries as they die. Eneloops have around 2000 mAh of capacity (versus 2100+ mAh for good alkaline batteries1), and run at a nominal 1.2V instead of the 1.5V of alkaline batteries.
...
So far, across 128 batteries, I have not had a single incident of leakage, fire, etc., and even the cells I reserve for outdoor use (in devices that go from -12Â°F in the winter to 105Â°F+ in the summer) are still holding a charge, over a decade later.
...
I was putting together [this clock](https://amzn.to/4qD2LHz) at my workbench, and at one point I needed to determine which resistor was 100KÎ© and which was 1MÎ©. I pulled out my Fluke multimeter, inserted two AAA batteries I had sitting on my bench (I keep 8 AA and 8 AAA batteries charged and ready at my workbench, and don't store them in my tools), and measured the resistors.

Upon doing so, I realized the clamp meter I was using ([Fluke 323 True RMS Clamp Meter](https://amzn.to/4bgJSFH)) only measures between 400-4000Î©, so I switched to my old Craftsman meter that worked a treatâand uses a replaceable 9V battery!
...
![Sony Walkman WM-FX281 FM radio in use](/blog/2026/ode-to-the-aa-battery/sony-walkman-wm-fx281.jpg)
...
My wife had both a [WM-EX150](https://walkman.land/sony/wm-ex150) (made in 1995) and a [WM-FX281](https://retrospekt.com/products/sony-walkman-wm-fx281-am-fm-portable-cassette-player). These are 31 and 25 years old, respectivelyâand outside the rubber belts being shot, the devices both work. The radio works good as new, and it would play cassettes again after a little maintenance.
...
Considering wireless input devices, though, Apple's [1st gen Magic Trackpad](https://en.wikipedia.org/wiki/Apple_pointing_devices#1st_generation) was AA-powered. Apparently Apple considered battery swaps so convenient they didn't even include a USB or Lightning connector2!
...
![Li-ion battery packs in a box on my desk](/blog/2026/ode-to-the-aa-battery/lithium-ion-battery-packs-in-box.jpeg)
...
* * *
  ...
  1. Project Farm has a great video exploring [which AA battery provides the best value / power / longevity](https://www.youtube.com/watch?v=7eloV0mp6CE). ↩︎

  2. I still prefer wired connections for my peripherals, though. ↩︎
...
## Further reading:
  ...
  * [Review: AUKEY 30,000 mAh USB-C Portable Charger (with USB A, USB C, Micro USB)](/blog/2017/review-aukey-30000-mah-usb-c-portable-charger-usb-usb-c-micro-usb/)
  * [Review: Intocircuit Power Castle 15000 mAh Dual USB portable charger](/blog/2015/intocircuit-power-castle-15000/)
  * [How I monitor and control all my powered devices (Zigbee + HA)](/blog/2025/how-i-monitor-and-control-all-my-powered-devices-zigbee-ha/)



  * [aa](/tags/aa/)
  * [battery](/tags/battery/)
  * [rechargeable](/tags/rechargeable/)
  * [li-ion](/tags/li-ion/)
  * [lithium](/tags/lithium/)
  * [ion](/tags/ion/)
  * [power](/tags/power/)
  * [repairability](/tags/repairability/)
  * [waste](/tags/waste/)
