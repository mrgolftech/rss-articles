...
**日期:** Mon, 26 Jan 2026 17:05:00 -0600

---

[](https://www.jeffgeerling.com/cdn-cgi/content?id=rKl.ONgipDyGyS6GpWJrHXrmLutG2DbtrtmvwHKNMlA-1770287276.262917-1.0.1.1-4iNcbxg7S2X7GcThYeoSfnUNtS_NaaYJfd6Gdked8Xo)
...
![PreSonus Eris E3.5 speakers on workbench](/blog/2026/recapping-my-5-year-old-studio-monitors/presonus-eris-e35-speakers.jpeg)
...
So something was definitely wrongâand it had gotten _worse_ just by moving the speakers and plugging them in again.

I recorded a full video going through the teardown, diagnosis, and fix on my 2nd channel, Level2Jeff:

## The Fix - Two Bad Caps

**tl;dw** : there are two 1000Âµf 25V capacitors inside that were both bulging after 5 years of daily use. Here they are post-removal:

![PreSonus Eris E3.5 old bulging capacitors](/blog/2026/recapping-my-5-year-old-studio-monitors/presonus-eris-e35-caps-bulging.jpeg)

Both caps were in a bit of a tight space, but I managed to replace them with 1000Âµf 35V caps that were slightly larger, through the use of a bit of force, and having the new caps hovering about 10mm above the top of the PCB instead of flush-mounted.

![PreSonus Eris E3.5 replaced caps with a little added height](/blog/2026/recapping-my-5-year-old-studio-monitors/presonus-eris-e35-replaced-caps.jpeg)
...
* * *
  ...
  1. The old setup was using a 3.5mm to RCA adapter cable, which is more [prone to interference](https://www.soundguys.com/balanced-vs-unbalanced-connections-60085/). ↩︎
...
## Further reading:
  ...
  * [Raspberry Pi is cheaper than a Mini PC again (that's not good)](/blog/2026/raspberry-pi-cheaper-than-mini-pc/)
  * [Why doesn't Apple make a standalone Touch ID?](/blog/2025/why-doesnt-apple-make-standalone-touch-id/)
  * [You can finally manage Macs with FileVault remotely in Tahoe](/blog/2025/you-can-finally-manage-macs-filevault-remotely-tahoe/)



  * [speakers](/tags/speakers/)
  * [audio](/tags/audio/)
  * [repair](/tags/repair/)
  * [youtube](/tags/youtube/)
  * [video](/tags/video/)
  * [level2jeff](/tags/level2jeff/)
  * [soldering](/tags/soldering/)
