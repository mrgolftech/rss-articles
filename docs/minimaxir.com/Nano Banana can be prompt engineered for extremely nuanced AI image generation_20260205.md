...
**日期:** Thu, 13 Nov 2025 09:30:00 -0800
...
* * *
  ...
  1. I would have preferred to compare the generations directly from the `gpt-image-1` endpoint for an apples-to-apples comparison, but OpenAI requires organization verification to access it, and I am not giving OpenAI my legal ID. ↩︎

  2. Note that ALL CAPS will not work with CLIP-based image generation models at a technical level, as CLIP's text encoder is uncased. ↩︎
...
[ ](/cdn-cgi/l/email-protection#d8b5b9a098b5b1b6b1b5b9a0b1aaf6bbb7b5 "Email")[ ](https://bsky.app/profile/minimaxir.bsky.social "Bluesky")[ ](https://github.com/minimaxir "Github")[ ](https://twitter.com/minimaxir "Twitter")[ ](https://www.linkedin.com/in/minimaxir "Linkedin")[ ](https://twitch.tv/minimaxir "Twitch")[](https://minimaxir.com/post/index.xml "Rss")

  * [ChatGPT](https://minimaxir.com/tag/chatgpt/)
  * [Nano Banana](https://minimaxir.com/tag/nano-banana/)

[« Prev  
Nano Banana Pro is the best AI image generator, with caveats ](https://minimaxir.com/2025/12/nano-banana-pro/)[Next »  
