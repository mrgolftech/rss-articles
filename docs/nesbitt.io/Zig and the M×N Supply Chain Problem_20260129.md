...
**来源:** https://nesbitt.io
**链接:** https://nesbitt.io/2026/01/29/zig-and-the-mxn-supply-chain-problem.html
**日期:** 2026-01-29T10:00:00+00:00

---

[](/) [Andrew Nesbitt](/)

  * [](/consulting/)  [](https://mastodon.social/@andrewnez)  [](https://github.com/andrew)  [](/feed.xml)
  * 


# Zig and the M×N Supply Chain Problem

[package-managers](/search#package-managers)[idea](/search#idea)
...
[The package management landscape](/2026/01/03/the-package-management-landscape.html) spans dozens of categories and hundreds of tools. For Zig to have the same tooling support as npm or Cargo, each of those tools either needs to add Zig support, or the Zig community needs to build alternatives.
...
**Enterprise artifact repositories.** [JFrog Artifactory](https://jfrog.com/artifactory/) and [Sonatype Nexus](https://www.sonatype.com/products/sonatype-nexus-repository) support proxying and hosting packages for many ecosystems, but Zig isn’t among them.
...
[](/2026/01/29/zig-and-the-mxn-supply-chain-problem.html) [Mastodon](https://mastodon.social/@andrewnez) · [GitHub](https://github.com/andrew) · [RSS](/feed.xml) · [Stats](/stats) · [Search](/search) · [About](/about) [View source](https://github.com/andrew/nesbitt.io/blob/master/_posts/2026-01-29-zig-and-the-mxn-supply-chain-problem.md)
